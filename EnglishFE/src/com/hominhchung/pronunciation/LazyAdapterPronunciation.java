...
public class LazyAdapterPronunciation extends BaseAdapter {

	private final Activity activity;
	private final ArrayList<HashMap<String, String>> data;
	private static LayoutInflater inflater=null;
	public LazyAdapterPronunciation(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data=d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		itemImage.setImageResource(ListPronunciationMainActivity.KEY_ITEM_IMAGE);
		tv_namelocal.setText(lesson.get(ListPronunciationMainActivity.KEY_LOCAL_TITLE));
		tv_enlocal.setText(lesson.get(ListPronunciationMainActivity.KEY_EN_TITLE));
		return vi;
	}
