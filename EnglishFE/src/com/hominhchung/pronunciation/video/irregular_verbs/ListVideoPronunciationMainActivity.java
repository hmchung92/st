...
public class ListVideoPronunciationMainActivity extends Activity {
	
	// List view
	private ListView lv;
	
	// Listview Adapter
	LazyAdapterPronunciationVideo adapter;
	...
	static final String KEY_LESSON = "item01"; // parent node
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //Sound Effects
        ...
        adapter=new LazyAdapterPronunciationVideo(this, sessionList);
