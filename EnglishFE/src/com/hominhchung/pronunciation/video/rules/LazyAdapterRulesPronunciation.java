...
public class LazyAdapterRulesPronunciation extends BaseAdapter {

	private final Activity activity;
	private final ArrayList<HashMap<String, String>> data;
	private static LayoutInflater inflater=null;
	public LazyAdapterRulesPronunciation(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data=d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		itemImage.setImageResource(ListTopicRulesMainActivity.KEY_ITEM_IMAGE);
		tv_namelocal.setText(lesson.get(ListTopicRulesMainActivity.KEY_LOCAL_TITLE));
		tv_enlocal.setText(lesson.get(ListTopicRulesMainActivity.KEY_EN_TITLE));
		return vi;
	}
