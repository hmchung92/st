...
public class AddEditNotesSpeaking extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(getString(R.string.speak))
				.setOnMenuItemClickListener(this.SpeakButtonClickListener)
				.setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
		

		menu.add(getString(R.string.save_note))
	...
	OnMenuItemClickListener SpeakButtonClickListener = new OnMenuItemClickListener() {
		public boolean onMenuItemClick(MenuItem item) {
			...
			try {
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(AddEditNotesSpeaking.this);
	...
	private void saveNote() {
		DatabaseConnectorSpeaking dbConnector = new DatabaseConnectorSpeaking(this);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case RESULT_SPEECH: {
			...
			if (resultCode == RESULT_OK && null != data) {
				...
				Toast.makeText(this, getString(R.string.operation_canceled), Toast.LENGTH_SHORT)
						.show();
				break;
			}
		}
