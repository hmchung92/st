...
public class LazyAdapterSpeaking extends BaseAdapter {

	private final Activity activity;
	private final ArrayList<HashMap<String, String>> data;
	private static LayoutInflater inflater = null;

	public LazyAdapterSpeaking(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data = d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		itemImage.setImageResource(ListSpeakingMainActivity.KEY_ITEM_IMAGE);
		tv_namelocal.setText(lesson
				.get(ListSpeakingMainActivity.KEY_LOCAL_TITLE));
		tv_enlocal.setText(lesson.get(ListSpeakingMainActivity.KEY_EN_TITLE));
		return vi;
	}
