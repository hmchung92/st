...
public class LessonSpeakTopic extends Activity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.speaking_lesson_100topic_2);
		...
		if (KEY_BUNDLE < 10) {
			...
			setTitle(getString(R.string.topic)+" 0" + KEY_BUNDLE);
		} else {
			txtNum.setText(KEY_BUNDLE + "");
			setTitle(getString(R.string.topic)+" "+KEY_BUNDLE);
		}
		...
		imageSound.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (pos < max) {
					...
					/*Toast.makeText(LessonSpeakTopic.this, content,
...
*/					speakOut(content);
	...
	private void setSound(int pos) {
		...
		content = en_title.get(pos).toString().trim();
		/*Toast.makeText(LessonSpeakTopic.this, content, Toast.LENGTH_LONG)
				.show(); */
	...
	public void getItemFromXML(Activity activity)
		...
		while (eventType != XmlPullParser.END_DOCUMENT) {
			if (eventType == XmlPullParser.START_TAG) {
				if (xpp.getName().equals("item"+KEY_BUNDLE)) {
