...
public class ListVideoExperienceMainActivity extends Activity {
	
	// List view
	private ListView lv;
	
	// Listview Adapter
	LazyAdapterExperienceVideo adapter;
	...
	static final String KEY_LESSON = "item02"; // parent node
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new LazyAdapterExperienceVideo(this, sessionList);
