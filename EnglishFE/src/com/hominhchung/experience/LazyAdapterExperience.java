...
public class LazyAdapterExperience extends BaseAdapter {

	private final Activity activity;
	private final ArrayList<HashMap<String, String>> data;
	private static LayoutInflater inflater=null;
	public LazyAdapterExperience(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data=d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		itemImage.setImageResource(ListExperienceMainActivity.KEY_ITEM_IMAGE);
		tv_namelocal.setText(lesson.get(ListExperienceMainActivity.KEY_LOCAL_TITLE));
		tv_enlocal.setText(lesson.get(ListExperienceMainActivity.KEY_EN_TITLE));
		return vi;
	}
