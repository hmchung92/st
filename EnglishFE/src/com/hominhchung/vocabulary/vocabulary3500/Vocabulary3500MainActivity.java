...
public class Vocabulary3500MainActivity extends Activity implements
	...
	public void loadDB() {
		...
		String sql = "select * from " + DB_TABLE + " where isread=" + type;
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			btn_sound.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					speakOut(content);
					/*
					 * Toast.makeText(ListVocabulary3500MainActivity.this,
					 * content, Toast.LENGTH_LONG).show(); Intent checkIntent =
					 * new Intent(); checkIntent
...
//							Toast.LENGTH_LONG).show();
	...
	public class GetDataTask extends AsyncTask<Void, Void, Void> {
		...
		protected void onPostExecute(Void paramVoid) {
			...
			if ((Vocabulary3500MainActivity.this.mProgressDialog != null)
					&& (Vocabulary3500MainActivity.this.mProgressDialog
							.isShowing()))
				Vocabulary3500MainActivity.this.mProgressDialog.dismiss();
		...
		protected void onPreExecute() {
			...
			Vocabulary3500MainActivity.this.mProgressDialog.show();
		}
	}
