...
public class LazyAdapterListening extends BaseAdapter {

	private final Activity activity;
	private final ArrayList<HashMap<String, String>> data;
	private static LayoutInflater inflater=null;
	public LazyAdapterListening(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data=d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		itemImage.setImageResource(ListListeningMainActivity.KEY_ITEM_IMAGE);
		tv_namelocal.setText(lesson.get(ListListeningMainActivity.KEY_LOCAL_TITLE));
		tv_enlocal.setText(lesson.get(ListListeningMainActivity.KEY_EN_TITLE));
		return vi;
	}
