...
public class DatabaseConnectorWriting {
	...
	private DatabaseHelperWriting dbOpenHelper;

	public DatabaseConnectorWriting(Context context) {
		dbOpenHelper = new DatabaseHelperWriting(context, DB_NAME, null,
				DATABASE_VERSION);
