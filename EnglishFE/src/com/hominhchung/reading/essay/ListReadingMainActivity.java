...
public class ListReadingMainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv1.setOnItemClickListener(new OnItemClickListener() {
        	...
        	public void onItemClick(AdapterView<?> a, View v, int position, long id) { 
            	...
            	Toast.makeText(ListReadingMainActivity.this, "Topic : " + " " + obj_itemDetails.getName(), Toast.LENGTH_LONG).show();
        		Intent ex= new Intent(ListReadingMainActivity.this,LessionReading.class);
        		int num=position+1;
        		ex.putExtra("title","Topic "+num);
				ex.putExtra("data","reading/topic"+num+".html");
				startActivity(ex);
				Effects.getInstance().playSound(Effects.SOUND_1);
            	//Toast.makeText(ListLessionEassays.this, "essays/topic"+num+".html", Toast.LENGTH_LONG).show();
        	}  
        });
    }
    ...
    public void getItemFromXML(Activity activity) throws XmlPullParserException, IOException{
		...
		XmlResourceParser xpp = res.getXml(R.xml.reading);
		xpp.next();
