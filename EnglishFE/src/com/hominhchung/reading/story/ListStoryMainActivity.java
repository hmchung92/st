package com.hominhchung.reading.story;
...
import com.hominhchung.reading.story.content.LessionStory;

public class ListStoryMainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lv1.setOnItemClickListener(new OnItemClickListener() {
        	...
        	public void onItemClick(AdapterView<?> a, View v, int position, long id) { 
            	...
            	Toast.makeText(ListStoryMainActivity.this, "Topic : " + " " + obj_itemDetails.getName(), Toast.LENGTH_LONG).show();
        		Intent ex= new Intent(ListStoryMainActivity.this,LessionStory.class);
        		int num=position+1;
