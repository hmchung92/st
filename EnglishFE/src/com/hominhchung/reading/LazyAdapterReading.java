...
public class LazyAdapterReading extends BaseAdapter {

	private final Activity activity;
	private final ArrayList<HashMap<String, String>> data;
	private static LayoutInflater inflater=null;
	public LazyAdapterReading(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data=d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		itemImage.setImageResource(ListReadingMainActivity.KEY_ITEM_IMAGE);
		tv_namelocal.setText(lesson.get(ListReadingMainActivity.KEY_LOCAL_TITLE));
		tv_enlocal.setText(lesson.get(ListReadingMainActivity.KEY_EN_TITLE));
		return vi;
	}
