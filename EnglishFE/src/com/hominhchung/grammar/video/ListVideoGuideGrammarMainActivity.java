...
public class ListVideoGuideGrammarMainActivity extends Activity {
	
	// List view
	private ListView lv;
	
	// Listview Adapter
	LazyAdapterGuideGrammarVideo adapter;
	...
	static final String KEY_LESSON = "item03"; // parent node
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new LazyAdapterGuideGrammarVideo(this, sessionList);
