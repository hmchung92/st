...
public class LazyAdapterGrammar extends BaseAdapter {

	private final Activity activity;
	private final ArrayList<HashMap<String, String>> data;
	private static LayoutInflater inflater=null;
	public LazyAdapterGrammar(Activity a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data=d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		itemImage.setImageResource(ListGrammarMainActivity.KEY_ITEM_IMAGE);
		tv_namelocal.setText(lesson.get(ListGrammarMainActivity.KEY_LOCAL_TITLE));
		tv_enlocal.setText(lesson.get(ListGrammarMainActivity.KEY_EN_TITLE));
		return vi;
	}
